...
int main()
{
	...
	while (keepLooping)
	{
		...
		case 7: cout << "There are " << countEmptyFirstClassSeats(firstClassSeats, firstClassRows, firstClassAisle) << " empty seats total.\n";
		    keepLooping = true;
		break;

		case 8: cout << "There are " << countEmptyCoachSeats(first5CoachSeats, first5CoachRows, first5CoachAisle, last5CoachSeats,
		...
		case 10: cout << "Closing the program...\n"; keepLooping = false;
		    break;

		default: cout << "Please choose between 1-10\n"; keepLooping = true;
...
void determineNumOfTotalEmptySeats(int& countEmptyRows, const int firstClassAisle, char firstClassSeats[][4], const int first5CoachAisle, char first5CoachSeats[][6],
...
int countEmptyCoachSeats(char first5CoachSeats[][6], const int first5CoachRows, const int first5CoachAisle, char last5CoachSeats[][6],
